...
function ImageSelector({ callback, scientificNameId, newImage }) {
  ...
  return (
    <Dialog open={true}>
      ...
      <DialogContent>
        <DialogContentText>
          Provide and image for this taxon in the form of an url, the ID of a
          media element at NBIC, or click a suggested image if any were found.
        </DialogContentText>
        <TextField
          autoFocus
          value={image}
        ...
        {/* Upload field for a custom local file */}
        <input
          type="file"
          accept="image/*"
          onChange={(e) => {
            ...
            var filestring = "data:" + file.type + ";base64,";
        ...
        {!!imageSuggestions["images"] && (
          <p>
            ...
            <div className="sideBySide suggestions">
              {!!loadingImageSuggestions && <CircularProgress size={25} />}
                ...
                return (
                  <Avatar
                    ...
                    src={
                      ...
                      i["url"].replace("file/", "Media/F") +
                      "?mode=128x128"
                    }
                    onClick={() => {
                      addImage("F" + i["url"].split("/").pop());
                    }}
                  />
                );
              })}
